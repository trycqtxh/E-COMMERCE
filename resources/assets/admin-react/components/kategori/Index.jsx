...
class Index extends Component{
	...
	handleEdit(id){
		this.props.history.push(`/kategori/${id}/edit`);
	}
	...
	render(){
		...
		return (
			<div className="row-fluid">
				<NavLink to="/kategori/create" className="btn btn-primary pull-right"><i className="icon-plus"></i> Konten Baru</NavLink>
				<br/>
				<br/>
				<br/>
